...
import { navigateToPage } from './Home.util';
        ...
        <>
            ...
            >
                <Box sx={{ width: '100%', maxWidth: 500 }}>
                    ...
                    <Button variant="contained" style={{ marginTop: '2vh', marginLeft: '35%', width: '30%' }} onClick={() => navigateToPage(navigate)}>See Software</Button>
                </Box>
            </Container>
        </>
    );
